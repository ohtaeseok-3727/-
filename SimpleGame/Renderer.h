...
class Renderer
{
  public:
    ...
    {
        return m_Post.settings;
    }

    std::string EffectStatus() const
    {
        return m_Post.Status();
    }
    ...
    bool CharacterAttack(int profession,
                         const char* clipId,
                         float milliseconds,
                         float footX,
                         float footY,
                         bool faceLeft);
    bool CombatVisual(const char* clipId,
                      float milliseconds,
                      float footX,
                      float footY,
                      bool faceLeft = false,
  ...
  private:
    ...
    static float CharacterScale(int profession);
